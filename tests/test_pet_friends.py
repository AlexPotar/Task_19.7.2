...
def test_add_new_pet_with_valid_data(name='Вини', animal_type='Кот', age='4', pet_photo='caty.jpg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Кот", "Пит", "2", "cat.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_successful_update_self_pet_info(name='Вини', animal_type='Кот', age=6):
...
def test_add_new_pet_simple_with_valid_data(name='Рекс', animal_type='Кот', age='3'):
...
# def test_add_photo_to_pet_with_valid_data(pet_photo='cat.jpg'):
...
#     # Проверяем - если список своих питомцев пустой, то добавляем нового и опять запрашиваем список своих питомцев
#     if len(my_pets['pets']) == 0:
#         pf.add_new_pet_simple(auth_key, "Петя-без-фото", "питон", "11")
#         _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
#
...
def test_get_my_pets_with_valid_key(filter='my_pets'):
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet_simple(auth_key, 'Вини', 'Кот', '4')
        _, my_pets = pf.get_list_of_pets(auth_key, filter)
...
def test_add_new_pet_with_symbols_in_name_type(name='>>#/$|?_(!]{}((~$', animal_type='[:[)%~^|?$%^$:(=%)', age='999', pet_photo='cat.jpg'):
...
def test_add_new_pet_with_str_in_age(name='Барс', animal_type=',кот', age='One',
                                     pet_photo='cat.jpg'):
